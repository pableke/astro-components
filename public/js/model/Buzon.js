...
function Buzon() {
    ...
    this.isValidOrganica = function(data) {
        let ok = i18n.reset().isKey("org-id", data["org-id"]); // id asociated to organica
        ok &= i18n.isKey("organica", data["org-id"], "No ha seleccionado correctamente la orgánica"); // autocomplete required number
