...
function Langs() {
    ...
    en.boolval = str => isset(str) ? _lang.msgBool[+BOOLEAN_TRUE.includes("" + str)] : null;
    es.boolval = str => isset(str) ? _lang.msgBool[+BOOLEAN_TRUE.includes("" + str)] : null;
    this.boolval = str => _lang.boolval(str);
